...
function Cart() {
  return (
    <div>
      <Link
        class="text-2xl flex items-center w-24 py-1 rounded hover:bg-primary-light hover:text-white m-2"
        to="/"
      >
        <TbArrowBackUp /> HOME
      </Link>
      <div className="max-w-6xl px-24 py-16 mx-auto mt-16 bg-white">
        ...
        <div className="flex items-center justify-around border-2 pr-7">
          ...
          <h className="font-bold text-primary-dark ">
        ...
        <div className="flex items-center justify-between p-2 border-2 ">
          <div>
            ...
            ></input>
            <button className="px-5 py-1 text-white rounded bg-primary-dark hover:bg-primary-light">
              APPLY COUPON
            </button>
          </div>
          <button className="p-3 text-white rounded bg-primary-dark hover:bg-primary-light">
            UPDATE CART
          </button>
        </div>
        ...
        <div className="flex justify-between mt-5">
          ...
          <div className="w-6/12">
            ...
            <div className="flex justify-around px-2 py-2 border-2 ">
            ...
            <div className="flex justify-center px-2 py-2 border-2">
              <button className="px-4 py-1 text-xl text-white rounded bg-primary-dark hover:bg-primary-light">
                PROCEED TO CHECKOUT
              </button>
            </div>
          </div>
